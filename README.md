...
Полностью офлайн, на GPU (faster-whisper / CTranslate2). Цель — лёгкий нативный
интерфейс, в который подгружаются модели; сейчас стоит самая тяжёлая (`large-v3`)
и работает быстро (~0.7 с на короткую фразу, RTX 3050, float16).
