...
class Config:
    ...
    hotwords: str = ("Claude Code, Passivbot, Hyperliquid, 1С, "
                     "faster-whisper, Keenetic, OData.")   # словарь терминов (sot_prev-биас)
...
_LEGACY_INITIAL_PROMPT = ("Claude Code, Passivbot, Hyperliquid, 1С, "
